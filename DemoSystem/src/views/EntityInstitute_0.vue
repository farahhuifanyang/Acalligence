    ...
    <el-row>
      <el-col :span="24">
        <div class="grid-content">
          <h2 class="title">实体 - 机构 - {{ single_institute.name }}</h2>
          ...
          <el-card class="box-card" shadow="hover">
            ...
            <el-col :span="18" class="entity-col">
              <div>
                <el-image style="width: 180px; height: 180px; padding: 20px" :src="require('../assets/PDOS.svg')"></el-image>
                <p style="width: 180px; padding: 20px">{{ single_institute.intro }}</p>
              </div>
            </el-col>

            <el-col :span="24" class="entity-col">
              <table class="table table-striped table-bordered" style="width: 530px; margin-bottom: 90px">
                <tr v-if="single_institute.name != null">
                  <td class="institute-column">名称</td>
                  <td class="institute-value">{{ single_institute.name }}</td>
                </tr>
                <tr v-if="single_institute.affiliatedWith != null">
                  <td class="institute-column">隶属机构</td>
                  <td class="institute-value">{{ single_institute.affiliatedWith }}</td>
                </tr>
                <tr v-if="single_institute.country_region != null">
                  <td class="institute-column">国家/地区</td>
                  <td class="institute-value">{{ single_institute.country_region }}</td>
                </tr>
                <tr v-if="single_institute.address != null">
                  <td class="institute-column">地址</td>
                  <td class="institute-value">{{ single_institute.address }}</td>
                </tr>
                <tr v-if="single_institute.website != null">
                  <td class="institute-column">官方网站</td>
                  <td class="institute-value">{{ single_institute.website }}</td>
                </tr>
                <tr v-if="single_institute.alias != null">
                  <td class="institute-column">别名</td>
                  <td class="institute-value">
                    <li class="institute-table-list" v-for="(sub, i) in single_institute.alias" :key="i">
                      {{ sub }}
                    </li>
                  </td>
                </tr>
                <tr v-if="single_institute.researchArea != null">
                  <td class="institute-column">研究领域</td>
                  <td class="institute-value">
                    <li class="institute-table-list" v-for="(sub, i) in single_institute.researchArea" :key="i">
                      {{ sub }}
                    </li>
                  </td>
                </tr>
                <!-- <tr v-if="single_institute.member != null">
                  <td class="institute-column">成员人数</td>
                  <td class="institute-value">{{ single_institute.member }}</td>
                </tr>
                <tr v-if="single_institute.leaders != null">
                  <td class="institute-column">历任领袖</td>
                  <td class="institute-value">
                    <li class="institute-table-list" v-for="(val, key, i) in single_institute.leaders" :key="i">
                      {{ key }}：{{ val }}
                    </li>
                  </td>
                </tr>
                <tr v-if="single_institute.factions != null">
                  <td class="institute-column">内部派系</td>
                  <td class="institute-value">
                    <li class="institute-table-list" v-for="(val, key, i) in single_institute.factions" :key="i">
                      {{ key }}：{{ val }}
                    </li>
                  </td>
                </tr> -->
                <tr v-if="single_institute.publications != null">
                  <td colspan="2" class="institute-column">代表工作</td>
                </tr>
                <tr v-for="(val, key, i) in single_institute.publications" :key="i">
                  <td class="institute-column">{{ key }}</td>
                  <td class="institute-value">
                    <li class="institute-table-list" v-for="(sub, j) in val" :key="j">
                      {{ sub }}
                    </li>
                  </td>
                </tr>
...
export default {
  ...
  mounted () {
    this.demo_institutes = require('../assets/demo_organizations.json');
    console.log(this.demo_institutes);
    this.single_institute = this.demo_institutes[0];
    console.log(this.single_institute);
