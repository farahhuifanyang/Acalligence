    ...
    <el-row>
      <el-col :span="24">
        <div class="grid-content">
          ...
          <h2 class="title">实体 - 学者 - {{ single_scholar.name }}</h2>
          <el-divider class="title-line"></el-divider>

          <el-card class="box-card" shadow="hover">
            <h3 class="subtitle">学者简介</h3>
            ...
            <el-col :span="18" class="entity-col">
              <div>
                ...
                <el-image style="width: 180px; height: 180px; padding: 20px" :src="require('../assets/' + 'morris.jpg')"></el-image>
                ...
                <p style="width: 180px; padding: 20px">{{ single_scholar.intro }}</p>
              </div>
            </el-col>

            <el-col :span="24" class="entity-col">
              <table class="table table-striped table-bordered" style="width: 530px; margin-bottom: 90px">
                <tr v-if="single_scholar.name != null">
                  <td class="column">名称</td>
                  <td class="value">{{ single_scholar.name }}</td>
                </tr>
                <tr v-if="single_scholar.gender != null">
                  <td class="column">性别</td>
                  <td class="value">{{ single_scholar.gender }}</td>
                </tr>
                <tr v-if="single_scholar.email != null">
                  <td class="column">邮箱</td>
                  <td class="value">{{ single_scholar.email }}</td>
                </tr>
                <tr v-if="single_scholar.relatedLink != null">
                  <td class="column">个人网站</td>
                  <td class="value">{{ single_scholar.relatedLink }}</td>
                </tr>
                <tr v-if="single_scholar.organizationId != null">
                  <td class="column">机构</td>
                  <td class="value">{{ 'Parallel and Distributed Operating Systems Group' }}</td>
                </tr>
                <tr v-if="single_scholar.department != null">
                  <td class="column">部门</td>
                  <td class="value">{{ single_scholar.department }}</td>
                </tr>
                <tr v-if="single_scholar.rank != null">
                  <td class="column">职称</td>
                  <td class="value">{{ single_scholar.rank }}</td>
                </tr>
                <tr v-if="single_scholar.highestEducation != null">
                  <td class="column">最高学历</td>
                  <td class="value">{{ single_scholar.highestEducation }}</td>
                </tr>
                <tr v-if="single_scholar.citation != null">
                  <td class="column">引用量</td>
                  <td class="value">{{ single_scholar.citation }}</td>
                </tr>
                <tr v-if="single_scholar.h-index != null">
                  <td class="column">h-指数</td>
                  <td class="value">{{ single_scholar.h_index }}</td>
                </tr>
                <tr v-if="single_scholar.papers != null">
                  <td class="column">论文数量</td>
                  <td class="value">{{ single_scholar.papers }}</td>
                </tr>
                ...
                <tr v-if="single_scholar.researchArea != null">
                  <td class="column">研究领域</td>
                  <td class="value" v-if="single_scholar.researchArea.length == 1">
                    {{ single_scholar.researchArea[0] }}
                  </td>
                  <td class="value" v-if="single_scholar.researchArea.length > 1">
                    <li class="table-list" v-for="(sub, i) in single_scholar.researchArea" :key="i">
                      {{ sub }}
                    </li>
                  </td>
                </tr>
                ...
                <!-- <tr v-if="single_scholar.detailedEducation != null">
                  <td class="column">职业</td>
                  <td class="value" v-if="single_scholar.detailedEducation.length == 1">
                    {{ single_scholar.detailedEducation[0] }}
                  </td>
                  <td class="value" v-if="single_scholar.detailedEducation.length > 1">
                    <li class="table-list" v-for="(sub, i) in single_scholar.detailedEducation" :key="i">
                      {{ sub }}
                    </li>
                  </td>
                </tr> -->
                ...
                <tr v-for="(val, key, i) in single_scholar.detailedEducation" :key="i">
                  <td class="column">{{ val.phase }}</td>
                  <tr class="value">
                    <tr>{{ val.university }}</tr>
                    <tr>{{ val.startYear }}</tr>
                  </tr>
                </tr> -->
                ...
                <!-- <tr v-if="single_scholar.detailedEducation != null"> -->
                  <tr v-for="(sub, i) in single_scholar.detailedEducation" :key="i">
                  <td colspan="2" class="value">
                    <li class="table-list" v-for="(v, k, j) in sub" :key="j">
                      {{ k + ': ' + v }}
                    </li>
                  </td>
                  </tr>
                ...
                <tr v-if="single_scholar.projects != null">
                  <td colspan="2" class="column">项目经历</td>
                </tr>
                <tr v-for="(val, key, i) in single_scholar.projects" :key="i">
                  <td class="column">{{ key }}</td>
                  <td class="value">{{ val }}</td>
                </tr>
...
export default {
  ...
  mounted() {
    this.demo_scholars = require('../assets/demo_scholars.json');
    console.log(this.demo_scholars);
    this.single_scholar = this.demo_scholars[0];
    console.log(this.single_scholar);
