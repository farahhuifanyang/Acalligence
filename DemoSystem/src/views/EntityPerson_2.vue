    ...
    <el-row>
      <el-col :span="24">
        <div class="grid-content">
          ...
          <h2 class="title">实体 - 人物 - {{ single_scholar.name }}</h2>
          ...
          <el-card class="box-card" shadow="hover">
            ...
            <el-col :span="18" class="entity-col">
              <div>
                ...
                <el-image style="width: 180px; height: 180px; padding: 20px" :src="require('../assets/' + single_scholar.img)"></el-image>
...
export default {
  ...
  mounted() {
    ...
    this.single_scholar = this.demo_scholars[2];
